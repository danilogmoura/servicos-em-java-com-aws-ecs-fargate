...
public class Service02Stack extends Stack {
    ...
    public Service02Stack(final Construct scope, final String id, final StackProps props, final Cluster cluster, final SnsTopic productEventsTopic) {
        ...
        ApplicationLoadBalancedFargateService service02 = ApplicationLoadBalancedFargateService.Builder.create(this, "ALB02")
                ...
                .taskImageOptions(
                        ApplicationLoadBalancedTaskImageOptions.builder()
                                ...
                                .image(ContainerImage.fromRegistry("danilogmoura/curso_aws_project02:1.0.0"))
                                .containerPort(9090)
